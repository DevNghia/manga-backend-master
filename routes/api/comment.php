...
Route::post('manga/{mangaId}/comments', [CommentController::class, 'store_manga_id']);
Route::post('manga/{mangaId}/comments/{chapterId}', [CommentController::class, 'store_chapter_id']);
